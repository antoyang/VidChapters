...
def parse_opts():
    ...
    parser.add_argument('--idr', type=str, default='',
                        help='id of this run (overwritting id)')
    ...
    parser.add_argument('--visual_feature_type', type=str, default='resnet_bn', choices=['c3d', 'resnet_bn', 'resnet', 'clip', 'clippreproj', 'clippostnorm'])
    parser.add_argument('--feature_dim', type=int, default=2048, help='dim of frame-level feature vector')
    ...
    parser.add_argument('--caption_decoder_type', type=str, default="light",
                        choices=['none','light', 'standard', 'gpt2'])
    ...
    parser.add_argument(
        ...
        dest="self_iou",
        action="store_false",
        help="self iou loss, deactivate for chapters as they are disjoint -> nan",
    )
    parser.add_argument('--load', type=str, default='', help='load checkpoint trained on another run')
    parser.add_argument('--load_vocab', type=str, default='', help='load checkpoint trained on another run')
