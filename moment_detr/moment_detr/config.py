...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument("--dset_name", type=str, choices=["hl", "chapters"], default="chapters")
        ...
        parser.add_argument("--use_speech", action="store_true")
        parser.add_argument("--use_speech_time", action="store_true")
        ...
        parser.add_argument("--max_speech_l", type=int, default=512)
        ...
        parser.add_argument("--v_feat_dirs_eval", type=str, nargs="+", default=[],
                            help="video feature dirs. If more than one, will concat their features. "
                                 "Note that sub ctx features are also accepted here.")
        ...
        parser.add_argument("--freeze_speech", action="store_true")
        self.parser = parser
    ...
    def parse(self):
        ...
        if isinstance(self, TestOptions):
            ...
            try:
                ...
                ctx_str = opt.ctx_mode
            opt.results_dir = os.path.join(opt.results_root,
                                           "-".join([opt.dset_name, ctx_str, opt.eval_id,
